      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          <h2 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
            <span className='text-orange-600'>AWS</span> File Upload
          </h2>
        </div>
          ...
          <div className='space-y-10 my-10 py-8 px-4 mx-auto sm:max-w-lg'>
            <form onSubmit={handleUpload} className='flex flex-col gap-2'>
              ...
              <button
                ...
                className='min-w-[7rem] relative font-medium text-gray-800/90 bg-orange-50 shadow-md ring-1 ring-inset ring-slate-200 py-2 px-4 rounded-md hover:bg-orange-100 duration-200 ease-in-out focus:outline-none focus:shadow-none hover:shadow-none disabled:cursor-progress'
              >
                {uploadProgressPercent > 0 ? (
                  <>
                    ...
                    <div
                      ...
                      aria-valuemin={0}
                      aria-valuemax={100}
                      className='absolute bottom-0 left-0 h-1 bg-orange-600 transition-all duration-300 ease-in-out rounded-b-md'
