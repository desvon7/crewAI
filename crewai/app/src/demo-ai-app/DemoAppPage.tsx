      ...
      <div className='mx-auto max-w-7xl px-6 lg:px-8'>
        <div className='mx-auto max-w-4xl text-center'>
          <h2 className='mt-2 text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl dark:text-white'>
            <span className='text-orange-600'>AI</span> Day Scheduler
          </h2>
        </div>
  ...
  return (
    <div className='flex flex-col justify-center gap-10'>
      <div className='flex flex-col gap-3'>
        <div className='flex items-center justify-between gap-3'>
         ...
         <button
            ...
            className={cn(
              'min-w-[7rem] font-medium text-gray-800/90 bg-orange-50 shadow-md ring-1 ring-inset ring-slate-200 py-2 px-4 rounded-md duration-200 ease-in-out focus:outline-none focus:shadow-none',
              description && 'hover:bg-orange-100 hover:shadow-none'
            )}
          >
            Add Task
          </button>
            ...
            <div className='flex flex-col gap-3'>
              <div className='flex items-center justify-between gap-3'>
                ...
                <input
                  ...
                  min={1}
                  max={24}
                  className='min-w-[7rem] text-gray-800/90 text-center font-medium rounded-md border border-gray-200 bg-orange-50 hover:bg-orange-100 shadow-md focus:outline-none focus:border-transparent focus:shadow-none duration-200 ease-in-out hover:shadow-none'
                  value={todaysHours}
      ...
      <button
        ...
        className='flex items-center justify-center min-w-[7rem] font-medium text-gray-800/90 bg-orange-50 shadow-md ring-1 ring-inset ring-slate-200 py-2 px-4 rounded-md hover:bg-orange-100 duration-200 ease-in-out focus:outline-none focus:shadow-none hover:shadow-none disabled:opacity-70 disabled:cursor-not-allowed'
      >
        {isPlanGenerating ? (
          <>
          ...
          <th
            className={cn(
              'flex items-center justify-between gap-5 py-4 px-3 text-slate-800 border rounded-md border-slate-200 bg-opacity-70',
              {
                ...
                'bg-orange-100': mainTask.priority === 'medium',
              }
            )}
          >
                  ...
                  <td
                    className={cn(
                      'flex items-center justify-between gap-4 py-2 px-3 text-slate-600 border rounded-md border-purple-100 bg-opacity-60',
                      {
                        ...
                        'bg-orange-50': mainTask.priority === 'medium',
                      }
                    )}
                  >
